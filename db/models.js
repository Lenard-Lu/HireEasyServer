...
mongoose.connect('mongodb+srv://HireEasyCloud:Password@hireeasy.cta9w.mongodb.net/hireeasy_db?retryWrites=true&w=majority')
const conn = mongoose.connection
conn.on('connected', () => {
  
  //if connect to local mongo db
  //console.log('db connect success to local mongodb!');
  console.log('db connect success to atlas mongodb!');
